...
namespace Spryker\Zed\SecurityMerchantPortalGui\Communication\Plugin\EventDispatcher;
...
class LastVisitedPageEventDispatcherPlugin extends AbstractPlugin implements EventDispatcherPluginInterface
{
    /**
     * {@inheritDoc}
     * - Saves the last visited Merchant Portal page URL on each GET response eligible for post-login redirect.
